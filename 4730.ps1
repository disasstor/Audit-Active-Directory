# Аудит удаления глобальной группы безопасности
# $args[0] - token
# $args[1] - chat id
...
for ($i = 0; $i -lt $event2.Count; $i++)
{
    ...
    $text.Add("Удалена группа безопасности: $eventtextgroup%0AАдминистратором: $eventtextadmin%0AСервер: $server%0A---------------%0A")
    }
}
